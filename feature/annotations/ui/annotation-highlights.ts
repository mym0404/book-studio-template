import {
  type Annotation,
  getAnnotationAnchorId,
} from '@/feature/annotations/model/annotation';
import { getTextQuoteRange } from '@/feature/reading/model/text-quote-selector';
...
/** Rebuilds marks from the unwrapped reading DOM so prior wrappers cannot affect quote matching. */
