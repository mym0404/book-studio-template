...
import { SavedAnnotationItem } from '@/components/saved-annotation-item';
import { getAnnotationAnchorId } from '@/lib/annotation';
import type { SavedHighlightGroup } from '@/lib/saved-highlights';
...
export const SavedHighlights = ({
  ...
  return (
    <section className="flex flex-col gap-3" aria-labelledby="saved-highlights">
      <div className="flex items-center justify-between gap-3">
        ...
        {groups.length > 0 ? (
          <button
            ...
            className="flex size-8 shrink-0 items-center justify-center rounded-lg border text-fd-muted-foreground transition-colors hover:bg-fd-accent hover:text-fd-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fd-ring"
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  />
                  <h3
                    className="max-w-[80%] text-center text-sm font-medium text-fd-muted-foreground"
                    id={titleId}
                  >
                    {group.title}
                  </h3>
