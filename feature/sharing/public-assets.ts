...
import { publicAssetRoute } from '@/feature/common/app';
...
/**
 * Rewrites only book assets and binds access to the page secret, canonical
 * page URL, processed-content digest, and asset path.
 */
