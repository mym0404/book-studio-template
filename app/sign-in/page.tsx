...
export default function SignInPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6 py-16">
      <section className="w-full max-w-md rounded-2xl border bg-fd-card p-8 shadow-sm">
        ...
        <div className="flex flex-col gap-4">
          {isSetup && (
            <label className="flex flex-col gap-2 text-sm font-medium">
              ...
              <input
                autoComplete="off"
                className="h-11 rounded-lg border bg-fd-background px-3 font-normal outline-none focus-visible:ring-2 focus-visible:ring-fd-ring"
                disabled={pending}
          ...
          <button
            className="h-11 rounded-lg bg-fd-primary px-5 font-semibold text-fd-primary-foreground disabled:cursor-not-allowed disabled:opacity-60"
