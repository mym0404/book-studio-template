    ...
    <>
      {isEntryResolved && (
        <>
          ...
          <PageAnnotations pathname={pathname} />
        </>
      )}
      {progress && (
        <div
          ...
          role="dialog"
        >
          <div className="w-full max-w-sm rounded-xl border bg-fd-popover p-5 shadow-xl">
            ...
            <div className="mt-5 flex justify-end gap-2">
              <button
                className="rounded-md border px-3 py-2 text-sm font-medium hover:bg-fd-accent"
                onClick={stayHere}
                type="button"
              >
                Stay here
